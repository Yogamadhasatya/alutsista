                  ...
                  <table class="table" id="x" style="text-align : center; font-size : 14px;">
                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                          <a class="edittoko" href="edit-pengajuan.php?id=<?php echo $d['kode'];?> &aksi=editpengajuan"><i class="fas fa-edit" style="color: green; width : 15px" ></i></a>
                          <a class="hapus" href="../config/proses.php?id=<?php echo $d['kode'];?> &aksi=hapussenjata" onclick="return confirm('Yakin Hapus?')"><i class="fas fa-trash" style="color : red; width : 15px"></i></a>
                        </td>
                      </tr>
                    <?php
                        }
